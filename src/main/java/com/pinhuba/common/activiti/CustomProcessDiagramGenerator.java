...
import com.pinhuba.common.activiti.graph.ActivitiHistoryGraphBuilder;
import com.pinhuba.common.activiti.graph.Edge;
import com.pinhuba.common.activiti.graph.Graph;
        ...
        for (HistoricActivityInstance historicActivityInstance : activityInstances) {
            ...
            if (activity != null) {
                if (historicActivityInstance.getEndTime() == null) {
                    // 节点正在运行中
                    signRunningNode(image, activity.getX(), activity.getY(),
                    ...
                    if (historicActivityInstance.getTaskId() != null) {
                        deleteReason = Context.getCommandContext()
                    ...
                    if ("跳过".equals(deleteReason)) {
                        signSkipNode(image, activity.getX(),activity.getY(),activity.getWidth(), activity.getHeight(),
                                historicActivityInstance.getActivityType());
                    } else {
                        signHistoryNode(image, activity.getX(),activity.getY(),activity.getWidth(),activity.getHeight(),
                                historicActivityInstance.getActivityType());
                    }
                }
            }
