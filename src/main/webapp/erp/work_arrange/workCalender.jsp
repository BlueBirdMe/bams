...
function init(index){
	...
	dwrWorkArrangeService.listOaCalender(year,month,day,index,dateback);
}
	...
	if(data.success == true){
		...
		if(data.resultList.length > 0){
			for ( var i = 0; i < data.resultList.length; i++) {
		        ...
		        td1.style.cssText ="text-alan:center";
...
function addCalender(index){
	var datetime = DWRUtil.getValue("newdate")+" "+index.id+":00";
...
function queryData(){
	...
	dwrWorkArrangeService.listOaCalender(year,month,day,0,dateback);
}
...
<body style="overflow: hidden">
	...
	<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<td style="padding-bottom: 5px; padding-top: 5px;">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style='padding-left: 30px;'><btn:btn onclick="queryData()" value=" 今 日 " width="50px"></btn:btn></td>
		...
		<tr style="height: 100%">
			<td valign="top">
				<div style="overflow: auto; height: 100%; border-top: 1px solid #D8D6D6; width: 100%">
					<sys:table tableTitle="日列表" width="100%" id="resultTable">
