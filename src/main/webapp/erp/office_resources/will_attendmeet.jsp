...
function queryData(){
	...
	var pager = getPager();
	dwrOfficeResourcesService.listWillAttendMeeting(meetapply,pager,queryCallback);
}
...
function dblCallback(obj){
	Sys.href('<%=contextPath%>/erp/office_resources/meetSummary_detail.jsp?cid='+obj.value+'&status=will_attendedmeet');
}
...
function add(){
	var url = '<%=contextPath%>/erp/office_resources/meetapply_add.jsp';
...
<%
	...
	btnList.add(new SysGridBtnBean("召开会议","add()","add.png"));
