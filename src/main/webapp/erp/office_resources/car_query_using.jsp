...
window.parent.parent.mainframe.location =encodeURI(encodeURI("<%=contextPath%>/erp/office_resources/car_use_add.jsp?carname="+name+"&carid="+id+"&begindate="+begindate+"&enddate="+enddate));
}
