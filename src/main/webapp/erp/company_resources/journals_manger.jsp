...
function queryData(){
	...
	var pager = getPager();
	dwrOACompanyResourcesService.getJournalsByPager(jour,pager,queryCallback);
}
...
function edit(id){
	MoveDiv.show('编辑期刊',"<%=contextPath%>/erp/company_resources/journals_add.jsp?jid="+id);
}
function del(id){
...
<%
	...
	grid.setImgheight("80");//不设置为自动
	grid.setImgdivwidth("90");
