...
function realbum(){
	window.location.href = "<%=contextPath%>/erp/company_resources/superphotos_manger.jsp";
}
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath %>/erp/company_resources/photo_detail.jsp?pid='+obj.value+'&noid=1');
...
<table cellpadding="0" cellspacing="0" border="0" align="center" height="100%">
	<tr>
		<td valign="top" height="160">
			<div class="requdivdetail"><label>查看帮助:&nbsp;您可以在这里查看相册信息！</label></div>
			<table class="detailtable" align="center">
				<tr>
					<th width="15%">相册名称</th>
					<td colspan="1" id="AlbumName" class="detailtabletd"></td>
				</tr>
				<tr>
					<th>创建人</th>
					<td id="CreateEmployee" class="detailtabletd"  >
					</td>
					<th>创建时间</th>
					<td id="AlbumTime" class="detailtabletd" colspan="1"></td>
				</tr>
				<tr>
					<th>类型</th>
					<td id="LibraryInfoName" class="detailtabletd"></td>
					<th>相片数量</th>
					<td id="count" class="detailtabletd"> </td>
				<tr>
					<th>相册描述</th>
					<td colspan="3" id="AlbnumDesc" class="detailtabletd"></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>	
		<td>		
		<%
		SysGrid grid = new SysGrid(request,"[ "+am.getAlbumName()+" ]相片列表");
