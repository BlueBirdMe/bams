...
function queryData() {
	...
	var pager = getPager();
	dwrOACompanyResourcesService.getWarehouselistByPager(warehouse, pager, queryCallback);
}
...
function edit(id) {
	MoveDiv.show('编辑知识', "<%=contextPath%>/erp/company_resources/ware_add.jsp?wid=" + id);
}
