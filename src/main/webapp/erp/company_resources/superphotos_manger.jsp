...
//查询方法
	function queryData(){
		...
		var pager = getPager();
		dwrOACompanyResourcesService.getsuperAlbumListByPager(album,pager,queryCallback);
	}
	...
	function dblCallback(obj){
		window.location.href = "<%=contextPath%>/erp/company_resources/photos_super_albumdetail.jsp?aid="+obj.value;
	}
	function edit(){
		if(getAllRecordArray() != false){
			MoveDiv.show('修改相册信息',"<%=contextPath%>/erp/company_resources/photos_manger_add.jsp?aid="+getAllRecordArray());
		}else{
			alertmsg("请选择要修改的相册...");
		}
	...
	function openphoto(){
		if(getAllRecordArray() != false){
			window.location.href = "<%=contextPath%>/erp/company_resources/photos_super_albumdetail.jsp?aid="+getAllRecordArray();
		}else{
			alertmsg("请选择要打开的相册...");
		}
	}
	function set(){
		if(getAllRecordArray() != false){
			MoveDiv.show('设置相册信息',"<%=contextPath%>/erp/company_resources/photos_albumset_set.jsp?aid="+getAllRecordArray());
		}else{
			alertmsg("请选择要设置的相册...");
		}
	}
...
<%
	...
	btnList.add(new SysGridBtnBean("设置范围","set()","sport_tennis.png"));
	btnList.add(new SysGridBtnBean("修改相册","edit()","edit.png"));
