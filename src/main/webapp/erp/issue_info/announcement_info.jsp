...
function dblCallback(obj){
	//MoveDiv.show('查看公告记录明细','<%=contextPath%>/erp/issue_info/announcement_detail.jsp?aid='+obj.value);
...
function edit(id){
    MoveDiv.show('编辑公告','<%=contextPath%>/erp/issue_info/announcement_add.jsp?announcementpk='+id+'&noid=2');
}
...
<%
    ...
    ArrayList<SysGridColumnBean> colList = UtilTool.getGridColumnList(UtilTool.getColumnShow(this.getServletContext(),"公告列表"));
