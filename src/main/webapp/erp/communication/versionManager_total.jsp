...
function getAllForums(method){
	dwrOaCommunicationService.getForumByAdmin(queryCallback);
}
			...
			//table detail
		       for ( var i = 0; i < data.resultList.length; i++) {
		          ...
		          //模块超链接
		          	...
		          	a1.href = "versionposts_manager.jsp?forumId="+data.resultList[i].primaryKey+"&forumName="+encodeURI(data.resultList[i].oaForumName);
