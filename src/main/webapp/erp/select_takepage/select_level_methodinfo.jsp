...
window.onload = function(){
	...
	var tree = new WebFXLoadTree("功能目录","<%=request.getContextPath()%>/erp/tree/methodinfo_tree.jsp?code=-1&treetype="+treetype+"");
...
function methodInfoIdclick(dialogId,myfrmname,method){
	treeclick(myfrmname);
