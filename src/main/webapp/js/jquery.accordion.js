;(function ($) {
    ...
    $.fn.extend({
        accordion: function (options, data) {
            ...
            return this.each(function () {
                ...
                } else if (!$(this).data("ui-accordion")) {
    ...
    $.ui.accordion = function (container, options) {
		...
		if (options.cookies) {
			options.active = $.cookie('accordion_cookie') == null ? options.active : Number($.cookie('accordion_cookie'));
		}
        ...
        options.headers.removeClass(options.selectedClass).not(options.active || "").next().hide();
    ...
    function clickHandler(event) {
		...
		if (options.cookies) {
			...
			$.cookie("accordion_cookie", $.inArray(obj, options.headers));
		}
